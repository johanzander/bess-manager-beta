...
Beta versioning restarts here to track the `v10.1.0` stable release. This
release covers what is genuinely new since `v10.1.0`; everything before that
shipped in earlier beta releases and in stable `v10.1.0`.
